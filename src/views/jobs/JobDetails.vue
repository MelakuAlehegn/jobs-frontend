<template>
  <main v-if="data" class="my-14 flex flex-col gap-10" id="main">
    <div
      class="bg-white pl-4 flex flex-col md:flex-row md:justify-between md:py-5 md:px-6 md:items-center gap-2 justify-between shadow-xl container mx-auto border-l-4 rounded-md pb-3"
      :class="{ 'border-l-coralRed': data['featured'] }"
    >
      <div
        class="flex flex-col gap-2 md:mr-7 md:flex-row md:gap-4 md:items-center"
      >
        <img class="w-12 -mt-6 md:mt-0 md:w-20" :src="data.logo" />
